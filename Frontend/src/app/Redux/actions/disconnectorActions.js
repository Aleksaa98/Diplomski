...
export const addDisconnector = (discnonnector) => async(dispatch) => {
   console.log(discnonnector);
    const disc = {mrId:'2312',name:'1231',description:'fsa',costPerUnitL:22,failureRate:23,IsUnderground:true,Phases:1,RatedVoltage:1,NormalOpen:true,Retained:true,SwitchOnCount:1,SubstationId:26,ReactiveBreakingCurrent:1}
