...
import { deleteFuse,getAllFuses,addFuse } from '../Redux/actions/fuseActions';
        ...
        return switches.map(element => {
            return (
                <tr key={element}>
                    <td>
                        <Dropdown>
                            <Dropdown.Toggle variant="btn btn-outline-danger btn-icon-text" id="dropdownMenuIconButton6">
                    ...
                    <td>{element.maxFaultCurrent}</td>
                    <td>{element.cutout ? <label className="badge badge-success">True</label> : <label className="badge badge-danger">False</label>}</td>
                    <td>{element.ratingCurrent}</td>
                </tr>
            )
        })
    }
        ...
        <div>
            ...
            <Dialog open={openAddMenu} onClose={() => setOpenAddMenu(!openAddMenu)} >
                <div className="col-23 grid-margin">
                    <div className="card">
                        <div className="card-body">
                            <h4 className="card-title">Add New Fuse</h4>
