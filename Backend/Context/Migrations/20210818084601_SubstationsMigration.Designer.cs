...
namespace Context.Migrations
{
    ...
    [Migration("20210818084601_SubstationsMigration")]
    partial class SubstationsMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Core.Substation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Wires.Breaker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<float>("InTransitTime")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Domain.Wires.Breaker", b =>
                {
                    b.HasOne("Domain.Core.Substation", null)
                        .WithMany("Breakers")
            ...
            modelBuilder.Entity("Domain.Core.Substation", b =>
                {
                    ...
                    b.Navigation("Disconnector");

                    b.Navigation("Fuses");

                    b.Navigation("LoadBreakSwitches");
                });
